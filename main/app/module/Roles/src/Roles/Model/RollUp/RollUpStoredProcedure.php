    ...
    public function getAllLocations()
    {
        ...
        try
        {
            $sql = "select distinct 
                    ...
                    trim(GetHigherLevelUserWithProfile(um.carlib_key,'Sales','SalesRegion'))      as sales_region_user,
                    trim(GetHigherLevelUnit(um.carlib_key,'Sales','SalesArea'))        as sales_area,
                    trim(GetHigherLevelUserWithProfile(um.carlib_key,'Sales','SalesArea'))        as sales_area_user,
                    trim(GetHigherLevelUnit(um.carlib_key,'Admin','AdminDivision'))    as admin_division,
                    trim(GetHigherLevelUserWithProfile(um.carlib_key,'Admin','AdminDivision'))    as admin_division_user,
                    trim(GetHigherLevelUnit(um.carlib_key,'Admin','AdminRegion'))      as admin_region,
                    trim(GetHigherLevelUserWithProfile(um.carlib_key,'Admin','AdminRegion'))      as admin_region_user,
                    trim(GetHigherLevelUnit(um.carlib_key,'Admin','AdminArea'))        as admin_area,
                    trim(GetHigherLevelUserWithProfile(um.carlib_key,'Admin','AdminArea'))        as admin_area_user,
                    trim(GetHigherLevelUnit(um.carlib_key,'Maint','MaintDivision'))    as maint_division,
                    trim(GetHigherLevelUserWithProfile(um.carlib_key,'Maint','MaintDivision'))    as maint_division_user,
                    trim(GetHigherLevelUnit(um.carlib_key,'Maint','MaintRegion'))      as maint_region,
                    trim(GetHigherLevelUserWithProfile(um.carlib_key,'Maint','MaintRegion'))      as maint_region_user,
                    trim(GetHigherLevelUnit(um.carlib_key,'Maint','MaintArea'))        as maint_area,
                    trim(GetHigherLevelUserWithProfile(um.carlib_key,'Maint','MaintArea'))        as maint_area_user,
                    trim(GetHigherLevelUnit(um.carlib_key,'Funeral','FHDivision'))     as fhmgmt_division,
                    trim(GetHigherLevelUserWithProfile(um.carlib_key,'Funeral','FHDivision'))     as fhmgmt_division_user,

...
* `ZEND_ADMIN_PASSWORD` - This defines what password will be used by the admin account to access the Zend Server dashboard at <domainname>:10081. The Zend Server dashboard offers a wide variety of debug tools and configuration options, so it is useful to set this to something easy to remember.
